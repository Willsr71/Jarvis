...
public class CommandStats extends Command {
    ...
    public void execute(Message message, String... args) {
        ...
        embed.addField("Events/minute", Stats.getDataInTime("events", 60) + "", true);
        embed.addField("Messages/minute", Stats.getDataInTime("messages", 60) + "", true);
        embed.addField("Queries/minute", Stats.getDataInTime("queries", 60) + "", true);
